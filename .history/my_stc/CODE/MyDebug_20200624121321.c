 ...
 * @LastEditTime : 2020-06-24 12:13:20
 */ 
#include "MyDebug.h"
//上位机相关定义
float Variable[16];
...
{ 
  ...
  if(Page_Index==0)                
  {
    for(i=0;i<6;i++)
    {
      ...
      {
        oled_putpixel(72,i,0x00);
        oled_printf_float(72, i+1,*Control_Para0[i],4);
        oled_putpixel(72,i,0xff);
      }
