 ...
 * @LastEditTime : 2020-07-10 11:53:39
 */ 
...
//充电完成熄灯
  while (!System_OK)
  {
    if (Attitude_Angle.Y > -30 && Attitude_Angle.Y < 20 && )
    if (Attitude_Angle.Y > -30 && Attitude_Angle.Y < 20 && Battery_Ok==1)	
    {
      System_OK = 1;
      LED1 = !LED1;// 姿态进入充电范围后熄灯
    }
  }
