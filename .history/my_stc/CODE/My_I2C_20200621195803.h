 ...
 * @LastEdiors   : yan_wen
 * @LastEditTime : 2020-06-21 19:58:03
 */ 
#ifndef __My_I2C_H__
#define __My_I2C_H__
#include "common.h"
I#include "headfile.h"
typedef enum
{
    IIC_1 = 0,
...
void I2C_Init(IICN_enum iic_n,IIC_PIN_enum scl_pin,IIC_PIN_enum sda_pin);
void I2C_Change_Pin(IICN_enum iic_n,IIC_PIN_enum scl_pin,IIC_PIN_enum sda_pin);
#endif