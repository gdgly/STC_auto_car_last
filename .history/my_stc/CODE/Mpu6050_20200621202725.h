...
extern  bit ack;
//宏定义调用底层的I2C接口
#define MPU6050_OPEN()      	I2C_Init(IIC_1,IIC_SCL_P15,IIC_SDA_P14)
#define MPU6050_ADRESS          (0X68)      /*MPU6050_Device Address*/
#define MPU6050_WR(reg,value)  	I2C_Single_Write(MPU6050_ADRESS//mpu6050 写寄存器
#define MPU6050_RD(reg)         I2C_Single_Read(MPU6050_ADRESS, reg)		//mpu6050 读寄存器
