 ...
 * @LastEditTime : 2020-07-09 20:29:53
 */
#include "Balance.h"
S_FLOAT_XYZ
GYRO_Real,             // 陀螺仪转化后的数据
...
/* 各种标志位，放定时器中进行时序控制 */
char Speed_Flag, Angle_Flag, Ang_Velocity_Flag, Roundabout_cnt = 0, In_Roundabout_Flag = 0, Out_Roundabout_Flag = 0, DMP_F;
/********************* 串级平衡控制 *********************/
// 频率控制在定时器中设置
