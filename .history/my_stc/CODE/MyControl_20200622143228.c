 ...
 * @LastEditTime : 2020-06-22 14:32:27
 */ 
...
/******* 右电机速度相关控制 ********/
  ...
  right_data = P35;
  if(right_data==1)MOTOR_Speed_Right=-MOTOR_Speed_Right;    
  if(right_data==0)MOTOR_Speed_Right= MOTOR_Speed_Right;  
...
/******* 左电机速度相关控制 ********/
  ...
  left_data = P53;
  if(left_data==1)MOTOR_Speed_Left= MOTOR_Speed_Left;   
  if(left_data==0)MOTOR_Speed_Left=-MOTOR_Speed_Left;
  ...
  if (LDuty >= 0)
	{
		...
		pwm_duty(MOTOR3_PWM,0);	  	// 占空比最大990！！！
