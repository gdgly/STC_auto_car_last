 ...
 * @LastEditTime : 2020-07-09 10:03:30
 */ 
#include "MyDebug.h"
//上位机相关定义
float Variable[30];
...
void Testdata_generate()
{
  ...
  //Variable[i]=RADC;
  // Variable[i]=RAD;
  //Variable[i]=In_Roundabout_Flag;
  //Variable[i]=Out_Roundabout_Flag;
  //Variable[i]=In_Out_Roundabout_ture_I;
  //Variable[i]=Attitude_Angle.Z;
  dd//seekfree_wireless_send_buff(Variable,sizeof(Variable));
}
/**************屏幕显示************/
