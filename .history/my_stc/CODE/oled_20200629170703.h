 ...
 * @LastEditTime : 2020-06-29 17:06:57
 */ 
...
#define D1_HIGH gpio_set (D1,1)D1 = 1
#define D1_LOW  gpio_set (D1,0)D1 = 0

#define RST_HIGH gpio_set (RST,1)RST = 1
#define RST_LOW  gpio_set (RST,0)RST = 0
