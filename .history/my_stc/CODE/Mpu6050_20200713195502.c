 ...
 * @LastEditTime : 2020-07-13 19:54:57
 */
#include "Mpu6050.h"
...
*/
#define K1 = 0.04
const float Turn_to_Ang_need = 57.2958; 
const float dt = 0.001;
float zero;
uint8 zero_get_time = 20;
float Ang_ACC,gyro_y
void Another_Get_Attitude(void)
{
  ;
  Ang_ACC = Turn_to_Ang_need*(float)(atan2(ACC_Real.Z, ACC_Real.X));
  gyro_y = GYRO.Y - zero;
  Attitude_Angle.Y = K1 * Ang_ACC + (1-K1) * (Attitude_Angle.Y + gyro_y * dt);
}